<?php
// ИЗМЕНИТЬ типа входящего обращения 'inbox_type_id' на экспресс
//include_once 'db.php';
...
/*if (!$name || !$phone || !$value8 || !$value6) {
  logFileWriter($memberId, 'ЗВОНКИ. Заказ НЕ передан в CRM. Обязательные данные не заполнены. Возможно файл был запущен без аргументов.', 'ERROR');
...
'inbox_type_id' => 745712, // id типа входящего обращения: 374553 - сайт, 458658 - обзвон, 745712 Экспресс
