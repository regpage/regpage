...
$(document).ready(function(){
 ...
 function save_select_field_extra(field, value, header) {
   ...
   if (field === "book_ot" || field === "book_nt") {
     ...
     if (field === "book_ot") {
       data += "&id=" + $("#bible_book_ot").attr("data-id");
     } else {
       data += "&id=" + $("#bible_book_nt").attr("data-id");
     }

     fetch('internal_api.php?category=ftt_reading&type=set_reading' + data) //ajax/ftt_reading_ajax.php?type=set_reading_bible
     .then(response => response.json())
     .then(commits => {
       //console.log(commits.result);
     });
 ...
 $('#send_blank').click(function (e) {
   ...
   if (($("#bible_book_ot").is(":visible") && !$("#bible_book_ot").val() && !$("#bible_book_ot").attr("disabled")) || ($("#bible_book_nt").is(":visible") && !$("#bible_book_nt").val()  && !$("#bible_book_nt").attr("disabled"))) {
     ...
     if ($(".reading_bible_title").attr("data-book_ot") && ($("#bible_book_ot").val() === "_none_" || !$("#bible_book_ot").val())) {
       $("#bible_book_ot").css("border-color", "red");
     } else {
       $("#bible_book_ot").css("border-color", "lightgray");
     }
     if ($(".reading_bible_title").attr("data-book_nt") && ($("#bible_book_nt").val() === "_none_" || !$("#bible_book_nt").val())) {
...
//    $("#bible_chapter").val(el_this.attr("data-bible_chapter"));
    ...
    // bible
    // *** BIBLE HERE *** //
    function reset_reading_block() {
      $("#show_me_start").attr("disabled", false);
      $("#bible_book_ot").attr("data-id", '');
      $("#bible_book_nt").attr("data-id", '');
      $("#bible_book_ot").attr("disabled", false);
      $("#bible_book_nt").attr("disabled", false);
      $("#bible_book_ot").html("<option value='_none_'>ВЗ");
      $("#bible_book_nt").html("<option value='_none_'>НЗ");
      $("#bible_book_ot").val('_none_');
      $("#bible_book_nt").val('_none_');
      $(".reading_bible_title").attr("data-book_ot", '');
      $(".reading_bible_title").attr("data-notes_ot", '');
      $(".reading_bible_title").attr("data-book_nt", '');
      $(".reading_bible_title").attr("data-notes_nt", '');
    }
    reset_reading_block();
    setTimeout(function () {
      fetch("internal_api.php?category=ftt_reading&type=get_reading_data&member_key=" // ajax/ftt_reading_ajax.php?
      ...
      .then(commits => {
       ...
       if (reading_str['ot'] === null && reading_str['nt'] === null) {
          ...
          let textNt = '';
          if (reading_str['ot']) {
            if (reading_str['ot']["footnotes"] === "1") {
              notes_ot += " с прим.";
            }
            $(".reading_bible_title").attr("data-book_ot", reading_str["ot"]["book"]);
            $(".reading_bible_title").attr("data-notes_ot", reading_str["ot"]["footnotes"]);
            // $("#bible_book_ot").attr("data-id", reading_str["ot"]["id"]);
            textOt = reading_str["ot"]["book"] + notes_ot;
          }

          if (reading_str['nt']) {
            if (reading_str["nt"]["footnotes"] === "1") {
              notes_nt += " с прим.";
            }
            $(".reading_bible_title").attr("data-book_nt", reading_str["nt"]["book"]);
            $(".reading_bible_title").attr("data-notes_nt", reading_str["nt"]["footnotes"]);
            // $("#bible_book_nt").attr("data-id", reading_str["nt"]["id"]);
            textNt = reading_str["nt"]["book"] + notes_nt;
          }
          if (reading_str['nt'] && reading_str['ot']) {
            if (reading_str['nt']["book"] && reading_str['nt']["book"] !== undefined  && reading_str['ot']["book"] && reading_str['ot']["book"] !== undefined) {
              comma = ", ";
            }
          }
          $(".reading_bible_title").text("Чтение Библии " + "(" + textOt + comma + textNt + ")");
        }

        if (reading_str["ot"]) {
          if (reading_str["ot"]['book'] && $("#modalAddEdit").attr("data-status") === "0") {
            $("#bible_book_ot").attr("disabled", false).css("background-color", "white");
            $("#bible_book_ot").show();
          }
          // OT
          if (reading_str["ot"]['chapter'] == 0 && reading_str["ot"]["extra"] !== undefined && reading_str["nt"]["extra"] !== null) {
            render_bible_chapters(reading_str["ot"]["extra"]["book"], reading_str["ot"]["extra"]['chapter'], "#bible_book_ot");
          } else {
            render_bible_chapters(reading_str["ot"]["book"], reading_str["ot"]['chapter'], "#bible_book_ot");
          }
          if (reading_str["ot"]["date"] == el_this.attr("data-date") && reading_str["ot"]['start'] != '1') { //  && reading_str['today_ot']
            if (reading_str["ot"]['chapter'] === 0) {
              $("#bible_book_ot").val(0);
            } else {
              $("#bible_book_ot").val(reading_str["ot"]["book"] + " " + reading_str["ot"]['chapter']);
            }
            $("#bible_book_ot").attr("data-id", reading_str["ot"]["id"]);
        ...
        if (reading_str["nt"]) {
          if (reading_str["nt"]['book'] && $("#modalAddEdit").attr("data-status") === "0") {
            $("#bible_book_nt").attr("disabled", false).css("background-color", "white");
          }
          // NT
          if (reading_str["nt"]['chapter'] == 0  && reading_str["nt"]["extra"] !== undefined && reading_str["nt"]["extra"] !== null) {
            render_bible_chapters(reading_str["nt"]["extra"]["book"], reading_str["nt"]["extra"]['chapter'], "#bible_book_nt");
          } else {
            render_bible_chapters(reading_str["nt"]["book"], reading_str["nt"]['chapter'], "#bible_book_nt");
          }
          if (reading_str["nt"]["date"] == el_this.attr("data-date") && reading_str["nt"]['start'] != '1') { //reading_str['today_nt']
            if (reading_str["nt"]['chapter'] == 0) {
              $("#bible_book_nt").val(0);
            } else {
              $("#bible_book_nt").val(reading_str["nt"]["book"] + " " + reading_str["nt"]['chapter']);
            }
            $("#bible_book_nt").attr("data-id", reading_str["nt"]["id"]);
        ...
        if ($("#bible_book_ot").attr("data-complete") === "1") {
          $("#bible_book_ot").attr("disabled", true).css("background-color", "#f8f9fa");
        }
        if ($("#bible_book_nt").attr("data-complete") === "1") {
          $("#bible_book_nt").attr("disabled", true).css("background-color", "#f8f9fa");
        }
...
*/
 ...
 $("#add_attendance_str").click(function() {
  ...
  /*** BIBLE READING BEGIN ***/
  // ЧТЕНИЕ БИБЛИИ СТАРТ
  // Открытие окна старта
  $("#show_me_start").click(function () {
    // сброс формы
    $("#mdl_bible_start input[type='checked']").prop("checked", false);
    $("#mdl_bible_start input").attr("disabled", false);
    ...
    fetch("internal_api.php?category=ftt_reading&type=get_read_books&member_key=" + $("#modalAddEdit").attr("data-member_key")) // ajax/ftt_reading_ajax.php?
    .then(response => response.json())
    .then(commits => {
    ...
    setTimeout(function () {
      fetch("internal_api.php?category=ftt_reading&type=get_start_less_date&member_key=" // ajax/ftt_reading_ajax.php?type=get_start_reading_bible
      + $("#modalAddEdit").attr("data-member_key") + "&date=" + $("#modalAddEdit").attr("data-date"))
      .then(response => response.json())
      .then(commits => {
        // правила для окна старта
        let book_ot_start = $(".reading_bible_title").attr("data-book_ot");
        let book_nt_start = $(".reading_bible_title").attr("data-book_nt");

        // Если старт установлен сегодня
        if (commits.result.id) {
          book_ot_start = commits.result.ot.book;
          book_nt_start = commits.result.nt.book;
        }
        ...
        if ($(".reading_bible_title").attr("data-book_ot")) { // если поле в листе не заблокировано НЕ ВЕРНО ДЛЯ СЛУЖАЩИХ
          // получаем и заполняем книги  и главы ВЗ в окне старта
          let disabled_checkbox_start_ot;
          if (commits.result?.ot?.id != null) {
            if (book_ot_start) {
              disabled_checkbox_start_ot = set_book_chapter_fnote_start_mdl(book_ot_start + " " + commits.result.ot.chapter, "o");
              if ($("#modalAddEdit").attr("data-date") === gl_date_now && !trainee_access) {
        ...
        } else { // если поле в листе не видимо ВЕРНО
        ...
        if ($(".reading_bible_title").attr("data-book_nt")) {
          ...
          if (commits.result?.nt?.id != null) {
            if (book_nt_start) {
              disabled_checkbox_start_nt = set_book_chapter_fnote_start_mdl(book_nt_start + " " + commits.result.nt.chapter, "n");
              if ($("#modalAddEdit").attr("data-date") === gl_date_now && !trainee_access) {
            ...
            if (!$("#bible_book_nt").attr("disabled") && !disabled_checkbox_start_nt && $("#modalAddEdit").attr("data-date") === gl_date_now) {
              disabled_bookfields_start_mdl("n", disabled_checkbox_start_nt);
            }
          }
        } else { // если поле в листе не видимо ВЕРНО
  ...
  // разблокирование кнопки сохранения старта
  $("#mdl_footnotes_ot_start, #mdl_footnotes_nt_start").change(function() {
    $("#set_start_reading_bible").attr("disabled", false);
  });

  // Изменение полей с книгами ВЗ и НЗ
  $("#bible_book_ot, #bible_book_nt").change(function (e) {
    ...
    if (prev_book !== book[0]) {
      ...
      + "&notes=" + notes
      + "&set=" + set;
      fetch("internal_api.php?category=ftt_reading&type=set_read_book_automatic&" + query) // ajax/ftt_reading_ajax.php?type=set_read_book_by_book
      .then(response => response.text())
      .then(commits => {
  ...
  function book_complete(part, book, member_key) {
    ...
    + "&checked=true";
    fetch("internal_api.php?category=ftt_reading&type=set_read_book" + query) // ajax/ftt_reading_ajax.php?type=set_read_book
    .then(response => response.json())
    .then(commits => {
  ...
  function calculate_bible_read() {
    ...
    fetch("internal_api.php?category=ftt_reading&type=get_bible_deff&trainee_id=" + $("#modalAddEdit").attr("data-member_key") // ajax/ftt_reading_ajax.php?
    + "&semester=" + semester_tmp)
    .then(response => response.json())
    .then(commits => {
      $("#bible_book_nt").attr("data-complete", commits.result.nt_complete);
      $("#bible_book_ot").attr("data-complete", commits.result.ot_complete);
      ...
      if ((commits.result.nt_current && (semester_tmp  === "1" || semester_tmp  === "2")) || (semester_tmp  === "3" || semester_tmp  === "4")) {
        if (commits.result.nt_deff > 0) {
          if (html) {
            html += "И не менее " + commits.result.nt_deff + "  глав Нового Завета в день.";
          } else {
  ...
  $("#mdl_book_ot_start, #mdl_book_nt_start").change(function() {
    // разблокируем кнопку сохраниения старта
    $("#set_start_reading_bible").attr("disabled", false);
  ...
  $("#set_start_reading_bible").click(function () {
    ...
    if ($("#mdl_nt_start").prop("checked") && $("#mdl_ot_start").prop("checked")) { // если отмечены обе книги
      chosen_book = 3;
    ...
    } else if ($("#mdl_ot_start").prop("checked")) { // если отмечен ВЗ
      chosen_book = 1;
      text_ot = $("#mdl_book_ot_start").val();
      if ($("#mdl_footnotes_ot_start").prop("checked")) {
        text_ot += " с прим.";
      }
    } else if ($("#mdl_nt_start").prop("checked")) { // если отмечен НЗ
      chosen_book = 2;
      text_nt = $("#mdl_book_nt_start").val();
      if ($("#mdl_footnotes_nt_start").prop("checked")) {
        text_nt += " с прим.";
    ...
    if ((footnotes_ot_change && $("#mdl_ot_start").prop("checked")) || (footnotes_nt_change && $("#mdl_nt_start").prop("checked"))) {
      ...
      if (confirm("Вы начинаете заново? Удалить предыдущую историю чтения по" + footnotes_ot_change + and + footnotes_nt_change + "?")) {
        fetch("internal_api.php?category=ftt_reading&type=dlt_history_reading_bible&member_key=" + window.adminId + "&ot=" + footnotes_ot_change + "&nt=" + footnotes_nt_change) // ajax/ftt_reading_ajax.php?type=dlt_history_reading_bible
        .then(response => response.json())
        .then(commits => {
    ...
    if (!$("#mdl_ot_start").attr("disabled") && $("#bible_book_ot").is(":visible") && !footnotes_ot_change && $("#bible_book_ot").val() !== "_none_") {
      ...
      if (found_temp && found_temp[1] === ot_temp[1]) {
        setTimeout(function () {
          let query_temp = "&member_key=" + $("#modalAddEdit").attr("data-member_key") + "&book=" + ot_temp[0] + "&chapter=" + ot_temp[1];
          fetch("internal_api.php?category=ftt_reading&type=set_read_book&part=ot&checked=true" + query_temp) // ajax/ftt_reading_ajax.php?type=set_read_book
          .then(response => response.text())
          .then(commits => {
    ...
    if (!$("#mdl_nt_start").attr("disabled") && $("#bible_book_nt").is(":visible") && !footnotes_nt_change && $("#bible_book_nt").val() !== "_none_") {
      ...
      if (found_temp && found_temp[1] === nt_temp[1]) {
        setTimeout(function () {
          let query_temp = "&member_key=" + $("#modalAddEdit").attr("data-member_key") + "&book=" + nt_temp[0] + "&chapter=" + nt_temp[1];
          fetch("internal_api.php?category=ftt_reading&type=set_read_book&part=nt&checked=true" + query_temp) // ajax/ftt_reading_ajax.php?type=set_read_book
          .then(response => response.text())
          .then(commits => {
    ...
    // set data in html
    let chapter_ot_extra = 0, chapter_nt_extra = 0;
    ...
    if ($("#mdl_ot_start").prop("checked")) {
      ...
      chapter_ot_extra = $("#mdl_chapter_ot_start").val();
    } else {
      $(".reading_bible_title").attr("data-notes_ot", "");
      $(".reading_bible_title").attr("data-book_ot", "");
      footnotes_ot = 0;
    ...
    if ($("#mdl_nt_start").prop("checked")) {
      ...
      chapter_nt_extra = $("#mdl_chapter_nt_start").val();
    } else {
      $(".reading_bible_title").attr("data-notes_nt", "");
      $(".reading_bible_title").attr("data-book_nt", "");
      footnotes_nt = 0;
    ...
    "&date=" + $("#modalAddEdit").attr("data-date") +
    "&chosen_book=" + 3 +
    "&book_ot=" + $(".reading_bible_title").attr("data-book_ot") +
    "&chapter_ot=" + chapter_ot_extra +
    "&footnotes_ot=" + footnotes_ot +
    "&book_nt=" + $(".reading_bible_title").attr("data-book_nt") +
    "&chapter_nt=" + chapter_nt_extra +
