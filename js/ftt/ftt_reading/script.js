    ...
    setTimeout(function () {
      ...
      .then(commits => {
        ...
        */
        ...
        // если указанная книга отмечена как прочитаная
        if (!$("#mdl_book_ot_start").val() && $("#mdl_book_ot_start option").val()) {
          disabled_bookfields_start_mdl("o", false);
        }

        if (!$("#mdl_book_nt_start").val() && $("#mdl_book_nt_start option").val()) {
