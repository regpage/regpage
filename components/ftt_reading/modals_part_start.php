    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          <div class="row mb-2">
              <div class="col-12">
                <h6>Выбор другой книги возможен только на сегодняшнюю дату и в том случае, если текущая книга дочитана до последней главы.</h6>
              </div>
              <span id="mdl_start_info" class="ml-3" style="color: red; font-weight: bold;"></span>
          </div>
          <!-- ВЗ -->
          <div class="row mb-2">
              <div class="col-1">
