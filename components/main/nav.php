<?php
include_once 'db/classes/help_system/help_system.php';

/*
$navPoints = [
  'index' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'all', 'type' => ''],
  'reg' => ['role' => '0', 'auth' => 'admin', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'members' => ['role' => '0', 'auth' => 'admin', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'visits' => ['role' => '0', 'auth' => 'admin', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'list' => ['role' => '0', 'auth' => 'admin', 'name' => '', 'path' => '', 'menu' => 'members', 'type' => ''],
  'login' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'all', 'type' => ''],
  'signup' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'all', 'type' => ''],
  'reference' => ['role' => '2', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'statistic' => ['role' => '', 'auth' => 'admin', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'youth' => ['role' => '', 'auth' => 'admin_zone', 'name' => '', 'path' => '', 'menu' => 'members', 'type' => ''],
  'event' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'practices' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'none', 'type' => ''],
  'contacts' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'settings' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => ''],
  'drop_list' => ['role' => '', 'auth' => '', 'name' => 'ещё', 'path' => '', 'menu' => 'main', 'type' => ''],
  'profile' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => 'tray'],
  'logout' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'all', 'type' => 'tray'],
  'panel' => ['role' => '2', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => 'tray'],
  'ftt_settings' => ['role' => '', 'auth' => 'ftt_serving_one', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => 'tray'],
  'help' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'main', 'type' => 'extra'],
  'application' => ['role' => '', 'auth' => '', 'name' => '', 'path' => '', 'menu' => 'none', 'type' => ''],
  'ftt_application' => ['role' => '', 'auth' => 'ftt_serving_one', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_schedule' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_announcement' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_attendance' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_service' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_gospel' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_absence' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_extrahelp' => ['role' => '', 'auth' => 'ftt', 'name' => '', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_list' => ['role' => '', 'auth' => '1', 'name' => 'ftt', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_reading' => ['role' => '', 'auth' => '1', 'name' => 'ftt', 'path' => '', 'menu' => 'ftt', 'type' => ''],
  'ftt_fellowship' => ['role' => '', 'auth' => '1', 'name' => 'ftt', 'path' => '', 'menu' => 'ftt', 'type' => '']
];
*/

$s = $_SERVER["SCRIPT_NAME"];
$isEventAdminNav = isset($memberId) ? Access::hasRightToHandleEvents($memberId) : false;
$h = ($_SERVER['PHP_SELF']);
$res = '';
Notices::checkNotice($memberId) ? $noticeOn = '' : $noticeOn = 'none';
$tempTmp = Notices::checkNotice($memberId);
            ...
            <a class="btn help_link" type="button" data-toggle="dropdown" style="background-color: white; font-size: 14px; padding: 3px 10px!important;"><i class="fa fa-question fa-lg"></i><span class="hide-name"></span></a>
              <ul class="dropdown-menu pull-right" style="padding: 5px; left: -320%; min-width: 190px">
                <?php
                  ...
                  $references = HelpSystem::getReferences($sortField, $sortType);
