...
<button id="get_statistics_btn" class="btn btn-primary btn-sm mr-2 rounded" type="button" title="Добавить новую запись" data-toggle="modal" data-target="#modal_statistics_md">
  <i class="d-inline d-sm-none fa fa-list"></i> <span class="d-none d-md-inline">Статистика</span>
</button>
