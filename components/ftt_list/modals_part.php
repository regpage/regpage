    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-6">
              ...
              <select id="gender" class="form-control form-control-sm" data-field="male" data-table="member">
      ...
      -->
        ...
        <div class="row">
          <div class="col-12">
            <label>Семестр</label>
            <select id="semester" class="form-control form-control-sm" data-field="semester" data-table="ftt_trainee" disabled>
              <option value="_none_" selected></option>
      ...
      <div class="modal-footer">
        <button id="save_blank" class="btn btn-sm btn-success" data-dismiss="modal" aria-hidden="true" style="">Сохранить</button>
...
<!-- SIDE PANEL -->
<!-- cd-panel -->
<div class="cd-panel cd-panel--from-right js-cd-panel-main" data-member_key="">
