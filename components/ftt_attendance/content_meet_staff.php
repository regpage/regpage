...
<div id="meet_list_content_staff" class="container">
  <div class="row mb-1">
    ...
    <div class="col-2 text_blue"><b id="meet_sort_time" class="cursor-pointer">Время<i class="<?php echo $meet_sort_time_ico; ?>"></i></b></div>
...
<?php
  foreach (get_communication_records_staff($serving_ones_flt, $trainee_flt, $meet_curent_sorting) as $key => $value) {
    ...
    echo "<div class='col-2'>{$comment_short}<br><span class='grey_text'>{$comment_short_trainee}</span></div>";
    echo "</div>";
  }
?>
</div>
