      ...
      <div class="modal-footer">
        <div class="w-100 text-right">
          <?php if (!$serving_trainee && $ftt_access['group'] !== 'trainee'): ?>
            <button id="delete_blank_gospel" class="btn btn-sm btn-secondary float-left" data-dismiss="modal" aria-hidden="true" style=""><i class="fa fa-trash" aria-hidden="true"></i></button>
          <?php endif; ?>
          <button id="send_gospel_blank" class="btn btn-sm btn-warning">Отправить</button>
...
<!-- ПЕЧАТЬ Статистика благовестия по датам -->
<div id="gospel_modal_statistic_dates" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
        <h5 class="mb-0">Статистика благовестия по датам</h5>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body">
        <div id="gospel_report_dates" class="container">
          <div class="row">
            <div class="col">
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <button id="print_button_dates" class="btn btn-sm btn-success" data-dismiss="modal" aria-hidden="true" style="">Печать</button>
