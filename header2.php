...
<script>
  ...
  gtag('config', 'UA-144838221-1');*/
    ...
    <link href="css/style2.css?v35" rel="stylesheet">
...
<?php } elseif ($_SERVER['PHP_SELF'] === '/ftt_fellowship.php' || $_SERVER['PHP_SELF'] === '/ftt_fellowship_bbd.php') { ?>
    <link href="css/ftt/ftt_fellowship.css?v10" rel="stylesheet">
...
<?php } ?>
    ...
    <script src="js/script2.js?v22" type="text/javascript"></script>
