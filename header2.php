...
<script>
  ...
  gtag('config', 'UA-144838221-1');
    ...
    <link href="css/style2.css?v16" rel="stylesheet">
...
<?php } elseif ($_SERVER['PHP_SELF'] === '/ftt_fellowship.php') { ?>
    <link href="css/ftt/ftt_fellowship.css?v1" rel="stylesheet">
<?php } ?>
    ...
    <script src="js/script2.js?v16" type="text/javascript"></script>
