    ...
    <div class="tab-content">
      <select class="controls span4 members-lists-combo" tooltip="Выберите нужный вам список здесь">
          ...
          <?php if ($roleThisAdmin===2) { ?>
            ...
            <option value="logAdmins" selected>Ответственные за регистрацию</option>
          <?php } ?>
      </select>
        <div class="btn-toolbar">
            ...
            <div class="btn-group">
                <select id="selMemberCategory" class="span2">
                    ...
                    <option value="logadmins">Лог администраторов</option>
                    <option value="event">Мероприятия (разр.)</option>
                    <option value="statistic">Архив (неотобр.)</option>
                </select>
            </div>
            <div class="btn-group">
...
<script src="/js/log_activities.js?v01"></script>
<?php
