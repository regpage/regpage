...
if (isset($_GET['type']) && $_GET['type'] === 'set_start_reading_bible') {
  echo json_encode(["result"=>set_start_reading_bible($_GET['member_key'], $_GET['date'], $_GET['chosen_book'], $_GET['book_ot'], $_GET['chapter_ot'], $_GET['footnotes_ot'], $_GET['book_nt'], $_GET['chapter_nt'], $_GET['footnotes_ot'])]);
  exit();
}
