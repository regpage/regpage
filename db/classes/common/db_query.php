 ...
 * ПАРАМЕТРЫ:
 * str $type 'str'/ any или '' метод вернёт строку / массив (запросить можно только одно поле)
 * str $type 'list' метод вернёт массив (запросить можно * или поля через запятую)
